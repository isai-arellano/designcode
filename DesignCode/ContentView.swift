    ...
    var body: some View {
        VStack (spacing:20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificate is proof that Isaí  has achieved the SwiftUI course with approval from a Isai.dev instructor.")
